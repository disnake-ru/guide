...
`discord.py`. Скорее всего, в будущем он будет переписан.
...
находится на странице документации <DocsLink ext="commands" reference="ext-commands-api-errors">Исключения</DocsLink>.
