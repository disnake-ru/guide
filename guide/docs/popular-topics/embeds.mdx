...
`Context` (`ctx.send`). В противном случае эмбед не будет отправлена.
...
-   Заголовок эмбедаs ограничен **256 символами**.
-   Описание эмбедаs ограничен **4096 символами**.
-   Максимум **25 полей**.
...
-   **10 эмбедов** может содержать одно сообщение.
