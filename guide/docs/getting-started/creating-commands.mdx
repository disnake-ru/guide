...
для вашей слэш команды. Ниже приведён код, демонстрирующий то же самое (сосредоточтесь на использовании `inter`, что
...
должны быть знакомы с использованием `ctx` в качесте аббревиатуры для передачи контекста в функцию. В этом руководстве
